...
<div class="space-y-6">
  <div class="neo-card">
    ...
    @if(session('success'))
      <div class="neo-badge neo-badge-green mb-4">{{ session('success') }}</div>
    @endif
      ...
      <table class="neo-table w-full">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <a href="{{ route('admin.user-shifts.show', $userShift) }}" class="neo-btn-secondary text-sm">VIEW</a>
              <a href="{{ route('admin.user-shifts.edit', $userShift) }}" class="neo-btn-secondary text-sm">EDIT</a>
