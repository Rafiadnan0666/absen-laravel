  ...
  <div class="flex-none w-full max-w-full p-3">
    <div class="relative flex flex-col min-w-0 mb-6 break-words bg-white border-0 border-transparent border-solid shadow-soft-xl rounded-2xl bg-clip-border">
      <div class="p-6 pb-0 mb-0 bg-white border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
        <h6 class="text-xl font-bold">Edit Permission</h6>
      </div>
      <div class="flex-auto p-6">
        <form action="{{ route('admin.permissions.update', $permission) }}" method="POST">
          ...
          @method('PUT')
          <div class="mb-4">
            <label for="nama_permission" class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700">Permission Name</label>
            <input type="text" id="nama_permission" name="nama_permission" value="{{ old('nama_permission', $permission->nama_permission) }}" required
