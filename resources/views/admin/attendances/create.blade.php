      ...
      <div class="flex-auto p-6">
        <form action="{{ route('admin.attendances.store') }}" method="POST">
          ...
          <div class="mb-4">
            ...
            <input type="time" id="jam_kerja" name="jam_kerja" value="{{ old('jam_kerja') }}"
              class="focus:shadow-soft-primary-outline text-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-fuchsia-300 focus:outline-none">
            @error('jam_kerja')
              <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
            @enderror
          ...
          <div class="mb-4">
            ...
            <input type="time" id="jam_lembur" name="jam_lembur" value="{{ old('jam_lembur') }}"
              class="focus:shadow-soft-primary-outline text-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-fuchsia-300 focus:outline-none">
            @error('jam_lembur')
              <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
            @enderror
          ...
          <div class="mb-4">
            ...
            <input type="number" id="menit_telat" name="menit_telat" value="{{ old('menit_telat') }}"
              class="focus:shadow-soft-primary-outline text-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-fuchsia-300 focus:outline-none"
          ...
          <div class="mb-4">
            ...
            <input type="number" id="menit_pulang_cepat" name="menit_pulang_cepat" value="{{ old('menit_pulang_cepat') }}"
              class="focus:shadow-soft-primary-outline text-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-fuchsia-300 focus:outline-none"
          ...
          <div class="mb-4">
            ...
            <div class="flex items-center">
              <input type="checkbox" id="face_verified" name="face_verified" value="1" {{ old('face_verified') ? 'checked' : '' }}
