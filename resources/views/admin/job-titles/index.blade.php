        ...
        <div class="overflow-x-auto">
          <table class="neo-table w-full mb-0 align-top">
            ...
            <tbody>
              ...
              <tr>
                <td>
                  <p class="mb-0 font-bold">{{ $jobTitle->id }}</p>
                </td>
                <td>
                  <p class="mb-0 font-bold">{{ $jobTitle->nama_jabatan }}</p>
                </td>
                <td>
                  <p class="mb-0">Rp {{ number_format($jobTitle->default_gaji, 0, ',', '.') }}</p>
                </td>
                <td>
                  <span class="neo-badge neo-badge-cyan">{{ $jobTitle->users_count }}</span>
                </td>
                <td class="text-center">
                  <a href="{{ route('admin.job-titles.show', $jobTitle) }}" class="neo-btn-secondary text-sm">View</a>
                  <a href="{{ route('admin.job-titles.edit', $jobTitle) }}" class="neo-btn-secondary text-sm">Edit</a>
