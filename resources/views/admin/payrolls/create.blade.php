  ...
  <div class="neo-card p-6">
    ...
    <form action="{{ route('admin.payrolls.store') }}" method="POST">
      ...
      <div class="mb-4">
        ...
        <neo-input type="date" id="periode_mulai" name="periode_mulai" value="{{ old('periode_mulai') }}" required></neo-input>
        @error('periode_mulai')
          <p class="text-neo-red text-sm mt-1">{{ $message }}</p>
        @enderror
      </div>
      ...
      <div class="mb-4">
        ...
        <neo-input type="date" id="periode_selesai" name="periode_selesai" value="{{ old('periode_selesai') }}" required></neo-input>
      ...
      <div class="mb-4">
        ...
        <neo-input type="number" step="0.01" id="gaji_pokok" name="gaji_pokok" value="{{ old('gaji_pokok') }}" placeholder="Enter base salary" required></neo-input>
        @error('gaji_pokok')
          <p class="text-neo-red text-sm mt-1">{{ $message }}</p>
        @enderror
      </div>
      ...
      <div class="mb-4">
        ...
        <neo-input type="number" step="0.01" id="total_lembur" name="total_lembur" value="{{ old('total_lembur') }}" placeholder="Enter overtime pay"></neo-input>
        @error('total_lembur')
          <p class="text-neo-red text-sm mt-1">{{ $message }}</p>
        @enderror
      </div>
      ...
      <div class="mb-4">
        ...
        <neo-input type="number" step="0.01" id="total_potongan" name="total_potongan" value="{{ old('total_potongan') }}" placeholder="Enter deductions"></neo-input>
      ...
      <div class="mb-4">
        ...
        <neo-input type="number" step="0.01" id="bonus" name="bonus" value="{{ old('bonus') }}" placeholder="Enter bonus"></neo-input>
        @error('bonus')
          <p class="text-neo-red text-sm mt-1">{{ $message }}</p>
        @enderror
      </div>
      ...
      <div class="mb-4">
        ...
        <neo-input type="number" step="0.01" id="total_gaji" name="total_gaji" value="{{ old('total_gaji') }}" placeholder="Enter total salary" required></neo-input>
        @error('total_gaji')
          <p class="text-neo-red text-sm mt-1">{{ $message }}</p>
        @enderror
      </div>
