      ...
      <div class="flex-auto p-6">
        <form action="{{ route('admin.payrolls.update', $payroll) }}" method="POST">
          ...
          <div class="mb-4">
            ...
            <input type="text" id="total_gaji_display" value="{{ old('total_gaji', $payroll->total_gaji) }}"
            ...
            <input type="hidden" id="total_gaji" name="total_gaji" value="{{ old('total_gaji', $payroll->total_gaji) }}">
